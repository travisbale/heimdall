...
type OIDCProviderConfig struct {
	...
	RegistrationAccessToken *string    // Token to manage the dynamic registration
	RegistrationClientURI   *string    // Endpoint to update/delete the registration
...
type OIDCSession struct {
	...
	RedirectURI    string
	TenantID       *uuid.UUID
	UserID         *uuid.UUID // For link operations, stores the authenticated user
	CreatedAt      time.Time
	ExpiresAt      time.Time
	Operation      string // 'login' or 'link'
}
