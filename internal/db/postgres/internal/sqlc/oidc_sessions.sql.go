...
INSERT INTO oidc_sessions (
    ...
    $1, $2, $3, $4, $5, $6, $7, $8, $9
) RETURNING id, state, code_verifier, oidc_provider_id, provider_type, redirect_uri, tenant_id, user_id, created_at, expires_at, operation
`
...
SELECT id, state, code_verifier, oidc_provider_id, provider_type, redirect_uri, tenant_id, user_id, created_at, expires_at, operation FROM oidc_sessions
