...
CREATE TABLE oidc_providers (
    ...
    registration_access_token TEXT NOT NULL DEFAULT '', -- Token to manage the dynamic registration
    registration_client_uri TEXT NOT NULL DEFAULT '', -- Endpoint to update/delete the registration
